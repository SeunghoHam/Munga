...
Shader "Glow"
{
	Properties
	{
		...
		[ASEEnd]_T_Glow_01("T_Glow_01", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_T_Glow_01 = IN.ase_texcoord7.xy * _T_Glow_01_ST.xy + _T_Glow_01_ST.zw;
				float4 tex2DNode9 = tex2D( _T_Glow_01, uv_T_Glow_01 );
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( IN.ase_color * ( _Main_Color * tex2DNode9.r ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( tex2DNode9.r * IN.ase_color.a );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_T_Glow_01 = IN.ase_texcoord2.xy * _T_Glow_01_ST.xy + _T_Glow_01_ST.zw;
				float4 tex2DNode9 = tex2D( _T_Glow_01, uv_T_Glow_01 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_T_Glow_01 = IN.ase_texcoord3.xy * _T_Glow_01_ST.xy + _T_Glow_01_ST.zw;
				float4 tex2DNode9 = tex2D( _T_Glow_01, uv_T_Glow_01 );
...
/*ASEBEGIN
Version=18912
-106;461;1586;730;1150;193;1;True;True
Node;AmplifyShaderEditor.SamplerNode;9;-784,128;Inherit;True;Property;_T_Glow_01;T_Glow_01;1;0;Create;True;0;0;0;False;0;False;-1;f2a3cc02bbafb6944be59b7bd312243d;f2a3cc02bbafb6944be59b7bd312243d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-684,-82;Inherit;False;Property;_Main_Color;Main_Color;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;12;-374,-117;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-457,122;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-192,204;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-146,7;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5024672BB32B55A436B4D7F07BB62A6D1A06D81A