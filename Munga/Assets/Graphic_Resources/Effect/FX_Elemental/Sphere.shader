...
Shader "Assets/Graphic_Resources/Effect/FX_Elemantal/Sphere"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_FXT_Noise28("FXT_Noise27", 2D) = "white" {}
		[HDR]_Main_Color1("Main_Color", Color) = (1,1,1,1)
		_Main_Pow1("Main_Pow", Float) = 2
		_Main_Str1("Main_Str", Float) = 1
		_Fresnel_Bias("Fresnel_Bias", Float) = 0
		_Fresnel_Scale("Fresnel_Scale", Float) = 0
		[ASEEnd]_Fresnel_Power("Fresnel_Power", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_FXT_Noise28 = IN.ase_texcoord7.xy * _FXT_Noise28_ST.xy + _FXT_Noise28_ST.zw;
				float temp_output_15_0 = ( pow( abs( tex2D( _FXT_Noise28, uv_FXT_Noise28 ).r ) , _Main_Pow1 ) * _Main_Str1 );
				...
				float3 Emission = ( _Main_Color1 * temp_output_15_0 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( ( _Main_Color1.a * temp_output_15_0 ) * saturate( fresnelNode14 ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_FXT_Noise28 = IN.ase_texcoord2.xy * _FXT_Noise28_ST.xy + _FXT_Noise28_ST.zw;
				float temp_output_15_0 = ( pow( abs( tex2D( _FXT_Noise28, uv_FXT_Noise28 ).r ) , _Main_Pow1 ) * _Main_Str1 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_FXT_Noise28 = IN.ase_texcoord3.xy * _FXT_Noise28_ST.xy + _FXT_Noise28_ST.zw;
				float temp_output_15_0 = ( pow( abs( tex2D( _FXT_Noise28, uv_FXT_Noise28 ).r ) , _Main_Pow1 ) * _Main_Str1 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
...
/*ASEBEGIN
Version=18912
354;213;1586;684;1211.874;261.1157;1.125;True;True
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-1611.039,-47.65994;Inherit;False;0;9;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-1307.663,-60.29398;Inherit;True;Property;_FXT_Noise28;FXT_Noise27;0;0;Create;True;0;0;0;False;0;False;-1;cbc6cf68c6cb60d4a96f969da02fb810;cbc6cf68c6cb60d4a96f969da02fb810;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;8;-925.5812,172.226;Inherit;False;Property;_Main_Pow1;Main_Pow;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;22;-1046.64,-32.72012;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-759.261,154.586;Inherit;False;Property;_Main_Str1;Main_Str;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;12;-842.4231,-40.71399;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-861.9993,617.509;Inherit;False;Property;_Fresnel_Power;Fresnel_Power;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;10;-880.222,266.726;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;24;-855.2493,532.009;Inherit;False;Property;_Fresnel_Scale;Fresnel_Scale;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-840.6243,445.3841;Inherit;False;Property;_Fresnel_Bias;Fresnel_Bias;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-696.2629,-43.23401;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;16;-672.3222,-272.5539;Inherit;False;Property;_Main_Color1;Main_Color;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;14;-590.4218,293.1859;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;17;-362.3622,299.4859;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-480.8006,120.566;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-318.2608,144.506;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-309.821,-35.09398;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=56BAEF03A1DB911CD2D38317B0AD893D34E05F93